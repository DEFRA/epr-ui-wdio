...
Feature: Common Landing Pages from Manage Submissions page
  As a Regulator,
  I want to ensure that when I navigate through different common links on the Submissions Details Page,
  ...
  Background: Open Regulator account page
    ...
    Then the user should be on the "regulators submission details" page

  Scenario: Submission Details Page Links Verification - Gov.uk
  ...
  Scenario: Submission Details Page Links Verification - pEPR: Regulators Service
  ...
  Scenario: Submission Details Page Links Verification - Cookies
  ...
  Scenario: Submission Details Page Links Verification - Privacy
  ...
  Scenario: Submission Details Page Links Verification - Accessibility
  ...
  Scenario: Submission Details Page Links Verification - Crown copyright
  ...
  Scenario: Submission Details Page Links Verification - Open Government Licence
  ...
  Scenario: Submission Details Page Links Verification - Feedback
    ...
    When the user switches back to the "regulators submission details" tab
    Then the user should be on the "regulators submission details" page