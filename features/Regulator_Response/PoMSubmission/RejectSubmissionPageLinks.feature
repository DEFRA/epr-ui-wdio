...
Feature: Common Landing Pages from Manage Submissions page
  As a Regulator,
  I want to ensure that when I navigate through different common links on the Reject Submissions Page,
  ...
  Background: Open Regulator account page
    ...
    And the user should be on the "regulators submission details" page
    And the user clicks "Reject" for pending submission
    Then the user should be on the "regulators reject submission" page

  Scenario: Reject Submissions Page Links Verification - Gov.uk
  ...
  Scenario: Reject Submissions Page Links Verification - pEPR: Regulators Service
  ...
  Scenario: Reject Submissions Page Links Verification - Cookies
  ...
  Scenario: Reject Submissions Page Links Verification - Privacy
  ...
  Scenario: Reject Submissions Page Links Verification - Accessibility
  ...
  Scenario: Reject Submissions Page Links Verification - Crown copyright
  ...
  Scenario: Reject Submissions Page Links Verification - Open Government Licence
  ...
  Scenario: Reject Submissions Page Links Verification - Feedback
    ...
    When the user switches back to the "regulators reject submission" tab
    Then the user should be on the "regulators reject submission" page