...
Feature: Common Landing Pages from Manage Submissions page
  ...
  Background: Open Regulator account page
    ...
    And the user clicks "Accept" for pending submission
    Then the user should be on the "regulators accept submission" page

  Scenario: Accept Submission Page Links Verification - Gov.uk
  ...
  Scenario: Accept Submission Page Links Verification - pEPR: Regulators Service
  ...
  Scenario: Accept Submission Page Links Verification - Cookies
  ...
  Scenario: Accept Submission Page Links Verification - Privacy
  ...
  Scenario: Accept Submission Page Links Verification - Accessibility
  ...
  Scenario: Accept Submission Page Links Verification - Crown copyright
  ...
  Scenario: Accept Submission Page Links Verification - Open Government Licence
  ...
  Scenario: Accept Submission Page Links Verification - Feedback
    ...
    When the user switches back to the "regulators accept submission" tab
    Then the user should be on the "regulators accept submission" page