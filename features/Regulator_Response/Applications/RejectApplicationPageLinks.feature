...
Feature: Common Landing Pages from Regulators Enrolment Requests page
  ...
  Background: Open Regulator account page
    ...
    And the user enters the Organisation Name: "Test_Reg_Applications13"
    When the user clicks on apply filter button
    And the user navigates to enrolment request details page of an organisation

  Scenario: Regulators Enrolment Requests Page Links Verification - Gov.uk
  ...
  Scenario: Regulators Enrolment Requests Page Links Verification - Accessibility
  ...
  Scenario: Regulators Enrolment Requests Page Links Verification - Crown copyright
  ...
  Scenario: Regulators Enrolment Requests Page Links Verification - Feedback
  ...
  Scenario: Regulators Enrolment Requests Page Links Verification - Open Government Licence
