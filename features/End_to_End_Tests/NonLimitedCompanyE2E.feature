Feature: Non Limited Company E2E functionality
    # As an approved user for a Non Limited Company,
    ...
    Scenario: Create Non Ltd Company, Regulator Approve, Upload and Submit Organisation, Brand and Partner Data
        And the user logs in as an automation test user for: "End to End Non Ltd Co. Org"
        And cookies "Accept" button should display
        And cookies are "Accepted"
        # Create Non Limited Company Account
        ...
        And the trading name is: "E2E Test Non Ltd Co"
        ...
        And the name is: "E2ETest" "NonLimitedCompany"
        ...
        # Filter application
        And the user enters the Organisation Name: "E2E Test Non Ltd Co"
    ...
    Scenario: Create Non Ltd Company, Upload and Submit Packaging Data
        And the user logs in as an automation test user for: "End to End Non Ltd Co. PoM"
        And cookies "Accept" button should display
        And cookies are "Accepted"
        # Create Non Limited Company Account
        Given the organisation is a registered charity: "No"
    ...
    Scenario: Create Non Ltd Company, Regulator Reject
