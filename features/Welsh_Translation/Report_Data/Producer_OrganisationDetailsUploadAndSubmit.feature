Feature: Organisation details from Producer: upload and submit - Welsh Translation
    ...
    Scenario: Report Organisation details - page
        ...
        And the Welsh page H1 header should be correct for the "producer organisation details sub landing" page
    ...
    Scenario: Upload Organisation details - page
        ...
        And the Welsh page H1 header should be correct for the "producer upload organisation details" page
    ...
    Scenario Outline: Review Organisation Data - a file submitted and new file uploaded
        ...
        And the "Welsh" toggle should be displayed
        When the user clicks the "Welsh" toggle
        Then the Welsh page H1 header should be correct for the "producer review organisation data: check file and re-submit" page
        Examples:
            | fileName    |
            | RegDataFile |
    ...
    Scenario Outline: Submission Declaration - page and validation
        When the user selects the "Report organisation details" card as "Producer"
        And the user navigates to "Report organisation details" page as a "Producer"
        Then the user should be on the "upload organisation details" page
        When the user uploads an Organisation data CSV file with a name <fileName>
        ...
        And the "Welsh" toggle should be displayed
        When the user clicks the "Welsh" toggle
        Then the Welsh page H1 header should be correct for the "declaration enter full name" page
